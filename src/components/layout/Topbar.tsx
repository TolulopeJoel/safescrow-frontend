...
const mockNotifications = [
  ...
  { id: 4, title: 'Order delivered', desc: 'Your package has been delivered.', read: false, time: '2h ago' },
  { id: 5, title: 'Dispute opened', desc: 'A dispute has been opened for Order #1234.', read: true, time: '3h ago' },
  { id: 6, title: 'Refund initiated', desc: 'A refund has been initiated for Order #1229.', read: false, time: '4h ago' },
  { id: 7, title: 'New message', desc: 'You have a new message from the seller.', read: false, time: '5h ago' },
  { id: 8, title: 'Order #1240 confirmed', desc: 'Seller confirmed your order.', read: true, time: '6h ago' },
  { id: 9, title: 'Reminder: Review seller', desc: 'Don’t forget to review your last seller.', read: false, time: '7h ago' },
  { id: 10, title: 'Offer received', desc: 'A buyer has made an offer for your item.', read: true, time: '8h ago' },
  { id: 11, title: 'Payment released', desc: 'Payment has been released to the seller.', read: false, time: '9h ago' },
  { id: 12, title: 'Account verification needed', desc: 'Please verify your identity to continue.', read: false, time: '10h ago' },
  ...
  { id: 15, title: 'Shipping address updated', desc: 'Your shipping address was changed.', read: false, time: '14h ago' },
  { id: 16, title: 'Password changed', desc: 'Your password has been successfully changed.', read: false, time: '15h ago' },
  { id: 17, title: 'Order #1250 cancelled', desc: 'Buyer cancelled the order.', read: true, time: '16h ago' },
  { id: 18, title: 'New feature available', desc: 'Try out the new escrow tracking system.', read: false, time: '17h ago' },
  { id: 19, title: 'Weekly summary', desc: 'Your weekly activity summary is ready.', read: true, time: '18h ago' },
  { id: 20, title: 'Support ticket replied', desc: 'Our team has replied to your support ticket.', read: false, time: '19h ago' },
  { id: 21, title: 'Promo alert', desc: 'Get 10% off your next transaction.', read: false, time: '1d ago' },
  { id: 22, title: 'Document uploaded', desc: 'Your verification document has been uploaded.', read: true, time: '1d ago' },
  { id: 23, title: 'Item favorited', desc: 'A user has favorited your item.', read: false, time: '1d ago' },
  { id: 24, title: 'Withdrawal processed', desc: 'Your wallet withdrawal is being processed.', read: true, time: '1d ago' },
  { id: 25, title: 'Order #1260 pending', desc: 'You have a pending order.', read: false, time: '1d ago' },
  ...
  { id: 28, title: 'Payment failed', desc: 'Your recent payment did not go through.', read: false, time: '2d ago' },
  { id: 29, title: 'Seller updated shipping', desc: 'Seller changed the shipping info.', read: false, time: '2d ago' },
